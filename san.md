...
<h1>我的简历</h1>
<p>
    聘用我，稳赚不赔！！！走过路过不要错过，只要998，现在只要998！！！
</p>

<a class="a">你还在因为找不到合适的员工苦恼吗</a>
<br/><br/><a class="b">你还在为公司发展担忧吗</a>
<br/><br/><a class="c">只要聘用我，相信可以解决你的困境</a>
————————————————
...
<p id="chinese">
   热爱学习，勤劳刻苦
    ...
    <form method="post" action="#">
        <div id="app2">
            <div>
                <span><a href="#" class="password-login">活泼开朗</a></span>
                <span><a href="#" class="sms-login">热情大方</a></span>
            </div>
            <div>
